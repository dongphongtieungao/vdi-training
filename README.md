...
Xây dựng tài liệu nhằm cung cấp kiến thức nền tảng và định hướng vận hành cho System Engineer khi tiếp cận hai hệ thống VDI quy mô lớn của khách hàng, gồm Omnissa Horizon trên hạ tầng HCI và Citrix Virtual Apps and Desktops trên XenServer hoặc VMware ESXi. Nội dung tài liệu tập trung giải thích mô hình kiến trúc, các thành phần chính, luồng kết nối người dùng, quản trị VDI, master image, phân quyền, cấp phát, thu hồi desktop, monitoring và xử lý sự cố thường gặp. Tài liệu được thiết kế cho engineer có mức độ kinh nghiệm khác nhau, từ người mới tiếp cận ảo hóa, Citrix, Horizon, network, storage đến người đã có nền tảng kỹ thuật, giúp họ nhanh chóng nắm được bức tranh tổng thể và chuẩn bị tốt hơn cho công việc vận hành thực tế tại môi trường khách hàng.
